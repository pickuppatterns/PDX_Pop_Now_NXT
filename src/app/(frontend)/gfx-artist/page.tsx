...
export const metadata: Metadata = {
  title: 'Festival Graphic Artists — PDX Pop Now!',
  description:
    'Each year PDX Pop Now! selects a local Portland artist to create the visual identity for the festival and compilation album artwork.',
}

export default async function GFXArtistPage() {
    ...
    <div className="container py-16">
      <div className="mb-12">
        ...
        <p className="text-[var(--color-text-secondary)] max-w-2xl">
          Each year PDX Pop Now! selects a local Portland artist to create the visual identity for
          the festival and compilation album artwork. {artists.length} artists since{' '}
          {artists[artists.length - 1]?.year}.
        </p>
      </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-text-secondary)]">
                  {artist.year} Festival
                  {compilation ? ` · Vol. ${(compilation as any).volume}` : ''}
                </p>
              </div>
            </Link>
          )
