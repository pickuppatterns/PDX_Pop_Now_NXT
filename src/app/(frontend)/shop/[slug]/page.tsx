  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Image */}
        <div className="aspect-square bg-[var(--color-content-bg)] relative rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-2xl text-[var(--color-text-primary)] mb-6">${((product.price ?? 0) / 100).toFixed(2)}</p>
